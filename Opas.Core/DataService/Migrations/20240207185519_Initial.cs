        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvestmentPlatform = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InquiryStatus = table.Column<int>(type: "int", nullable: false),
                    BestAvailability = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_inquiriesInquiries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_portfoliosUploadedFile", x => x.FileName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortfolioFileFileName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_portfoliosPortfolios_portfoliosUploadedFile_PortfolioFileFileName",
                        column: x => x.PortfolioFileFileName,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_portfoliosPortfolios_PortfolioFileFileName",
                table: "portfoliosPortfolios",
                column: "PortfolioFileFileName");
